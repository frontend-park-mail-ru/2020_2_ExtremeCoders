...
var pug_match_html=/["&<>]/;
function pug_rethrow(n,e,r,t){if(!(n instanceof Error))throw n;if(!("undefined"==typeof window&&e||t))throw n.message+=" on line "+r,n;try{t=t||require("fs").readFileSync(e,"utf8")}catch(e){pug_rethrow(n,null,r)}var i=3,a=t.split("\n"),o=Math.max(r-i,0),h=Math.min(a.length,r+i),i=a.slice(o,h).map(function(n,e){var t=e+o+1;return(t==r?"  > ":"    ")+t+"| "+n}).join("\n");throw n.path=e,n.message=(e||"Pug")+":"+r+"\n"+i+"\n\n"+n.message,n}function template(locals) {var pug_html = "", pug_mixins = {}, pug_interp;var pug_debug_filename, pug_debug_line;try {var pug_debug_sources = {"Menu.pug":"include  BaseComponents\u002Fbutton\ninclude BaseComponents\u002FpageTitle\n+pageTitle('Меню')\n+button('Войти','signin')\n+button('Регистрация', 'signup')\n+button('Профиль', 'profile')\n\n\u002F\u002Fexport {template}Регистрация","BaseComponents\u002Fbutton.pug":"mixin button(text, name)\n    button(class='', name=name) #{text}","BaseComponents\u002FpageTitle.pug":"mixin pageTitle(text)\n    h1(class='') #{text}"};
...
;pug_debug_line = 3;pug_debug_filename = "Menu.pug";
pug_mixins["pageTitle"]('Меню');
;pug_debug_line = 4;pug_debug_filename = "Menu.pug";
pug_mixins["button"]('Войти','signin');
;pug_debug_line = 5;pug_debug_filename = "Menu.pug";
pug_mixins["button"]('Регистрация', 'signup');
;pug_debug_line = 6;pug_debug_filename = "Menu.pug";
pug_mixins["button"]('Профиль', 'profile');
;pug_debug_line = 8;pug_debug_filename = "Menu.pug";
pug_html = pug_html + "\u003C!--export {template}Регистрация--\u003E";} catch (err) {pug_rethrow(err, pug_debug_filename, pug_debug_line, pug_debug_sources[pug_debug_filename]);};return pug_html;}
export {template}