...
;pug_debug_line = 6;pug_debug_filename = "ProfileEditForm.pug";
pug_mixins["pageTitle"]('Редактирование профиля');
;pug_debug_line = 8;pug_debug_filename = "ProfileEditForm.pug";
pug_html = pug_html + "\u003Cform method=\"POST\" enctype=\"multipart\u002Fform-data\"\u003E";
;pug_debug_line = 9;pug_debug_filename = "ProfileEditForm.pug";
pug_mixins["text"]('Имя');
;pug_debug_line = 10;pug_debug_filename = "ProfileEditForm.pug";
...
;pug_debug_line = 11;pug_debug_filename = "ProfileEditForm.pug";
pug_mixins["text"]('Фамилия');
;pug_debug_line = 12;pug_debug_filename = "ProfileEditForm.pug";
...
;pug_debug_line = 13;pug_debug_filename = "ProfileEditForm.pug";
pug_mixins["text"]('Аватар');
;pug_debug_line = 14;pug_debug_filename = "ProfileEditForm.pug";
pug_mixins["avatar"](locals.avatar);
;pug_debug_line = 15;pug_debug_filename = "ProfileEditForm.pug";
...
;pug_debug_line = 16;pug_debug_filename = "ProfileEditForm.pug";
pug_html = pug_html + "\u003Cinput" + (pug_attr("class", pug_classes([classNames.inputClass], [true]), false, false)+" type=\"submit\" value=\"Применить\"") + "\u002F\u003E";
;pug_debug_line = 17;pug_debug_filename = "ProfileEditForm.pug";
pug_mixins["button"]('Назад','back');
pug_html = pug_html + "\u003C\u002Fform\u003E";
;pug_debug_line = 19;pug_debug_filename = "ProfileEditForm.pug";
