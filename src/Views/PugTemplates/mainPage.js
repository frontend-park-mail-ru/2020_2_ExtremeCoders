...
pug_html = pug_html + "\u003Cinput" + (" class=\"Input disabled-input\""+" type=\"text\" readonly=\"readonly\""+pug_attr("placeholder", locals.letter.Sender, true, false)) + "\u002F\u003E";
