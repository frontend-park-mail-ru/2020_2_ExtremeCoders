...
;pug_debug_line = 2;pug_debug_filename = "BaseComponents\u002FLetterList.pug";
pug_mixins["LetterList"] = pug_interp = function(letters){
var block = (this && this.block), attributes = (this && this.attributes) || {};
;pug_debug_line = 3;pug_debug_filename = "BaseComponents\u002FLetterList.pug";
pug_html = pug_html + "\u003Cul\u003E\u003C\u002Ful\u003E";
;pug_debug_line = 4;pug_debug_filename = "BaseComponents\u002FLetterList.pug";
// iterate letters
;(function(){
  var $$obj = letters;
...
;pug_debug_line = 5;pug_debug_filename = "BaseComponents\u002FLetterList.pug";
pug_html = pug_html + "\u003Cli\u003E";
;pug_debug_line = 6;pug_debug_filename = "BaseComponents\u002FLetterList.pug";
pug_html = pug_html + "\u003Cdiv" + (pug_attr("id", letter.id, true, false)) + "\u003E";
;pug_debug_line = 7;pug_debug_filename = "BaseComponents\u002FLetterList.pug";
pug_html = pug_html + "\u003Cp\u003E";
;pug_debug_line = 7;pug_debug_filename = "BaseComponents\u002FLetterList.pug";
pug_html = pug_html + (pug_escape(null == (pug_interp = letter.sender) ? "" : pug_interp)) + "\u003C\u002Fp\u003E";
;pug_debug_line = 8;pug_debug_filename = "BaseComponents\u002FLetterList.pug";
pug_html = pug_html + "\u003Cp\u003E";
;pug_debug_line = 8;pug_debug_filename = "BaseComponents\u002FLetterList.pug";
pug_html = pug_html + (pug_escape(null == (pug_interp = letter.dateTime) ? "" : pug_interp)) + "\u003C\u002Fp\u003E";
;pug_debug_line = 9;pug_debug_filename = "BaseComponents\u002FLetterList.pug";
pug_html = pug_html + "\u003Cp\u003E";
;pug_debug_line = 9;pug_debug_filename = "BaseComponents\u002FLetterList.pug";
...
;pug_debug_line = 2;pug_debug_filename = "BaseComponents\u002FFolderList.pug";
pug_mixins["folders"] = pug_interp = function(data){
var block = (this && this.block), attributes = (this && this.attributes) || {};
;pug_debug_line = 3;pug_debug_filename = "BaseComponents\u002FFolderList.pug";
pug_html = pug_html + "\u003Cul\u003E";
;pug_debug_line = 3;pug_debug_filename = "BaseComponents\u002FFolderList.pug";
pug_html = pug_html + "Почтовый ящик";
;pug_debug_line = 4;pug_debug_filename = "BaseComponents\u002FFolderList.pug";
pug_html = pug_html + "\u003Cli\u003E";
;pug_debug_line = 5;pug_debug_filename = "BaseComponents\u002FFolderList.pug";
pug_mixins["button"]('Входящие', 'got', '');
pug_html = pug_html + "\u003C\u002Fli\u003E";
;pug_debug_line = 6;pug_debug_filename = "BaseComponents\u002FFolderList.pug";
pug_html = pug_html + "\u003Cli\u003E";
;pug_debug_line = 7;pug_debug_filename = "BaseComponents\u002FFolderList.pug";
pug_mixins["button"]('Отправленные', 'sended', '');
pug_html = pug_html + "\u003C\u002Fli\u003E\u003C\u002Ful\u003E";
};
;pug_debug_line = 8;pug_debug_filename = "BaseComponents\u002FFolderList.pug";
pug_html = pug_html + "\u003C!--export { template };--\u003E";
;pug_debug_line = 1;pug_debug_filename = "BaseComponents\u002FLetter.pug";
pug_mixins["Letter"] = pug_interp = function(letter){
var block = (this && this.block), attributes = (this && this.attributes) || {};
;pug_debug_line = 2;pug_debug_filename = "BaseComponents\u002FLetter.pug";
pug_html = pug_html + "\u003Cdiv" + (pug_attr("id", letter.id, true, false)) + "\u003E";
;pug_debug_line = 3;pug_debug_filename = "BaseComponents\u002FLetter.pug";
pug_html = pug_html + "\u003Cp\u003E";
;pug_debug_line = 3;pug_debug_filename = "BaseComponents\u002FLetter.pug";
pug_html = pug_html + (pug_escape(null == (pug_interp = letter.sender) ? "" : pug_interp)) + "\u003C\u002Fp\u003E";
;pug_debug_line = 4;pug_debug_filename = "BaseComponents\u002FLetter.pug";
pug_html = pug_html + "\u003Cp\u003E";
;pug_debug_line = 4;pug_debug_filename = "BaseComponents\u002FLetter.pug";
pug_html = pug_html + (pug_escape(null == (pug_interp = letter.dateTime) ? "" : pug_interp)) + "\u003C\u002Fp\u003E";
;pug_debug_line = 5;pug_debug_filename = "BaseComponents\u002FLetter.pug";
pug_html = pug_html + "\u003Cp\u003E";
;pug_debug_line = 5;pug_debug_filename = "BaseComponents\u002FLetter.pug";
pug_html = pug_html + (pug_escape(null == (pug_interp = letter.theme) ? "" : pug_interp)) + "\u003C\u002Fp\u003E";
;pug_debug_line = 6;pug_debug_filename = "BaseComponents\u002FLetter.pug";
pug_html = pug_html + "\u003Cp\u003E";
;pug_debug_line = 6;pug_debug_filename = "BaseComponents\u002FLetter.pug";
pug_html = pug_html + (pug_escape(null == (pug_interp = letter.text) ? "" : pug_interp)) + "\u003C\u002Fp\u003E\u003C\u002Fdiv\u003E";
};
;pug_debug_line = 5;pug_debug_filename = "mainPage.pug";
pug_html = pug_html + "\u003Cdiv class=\"folders\"\u003E";
;pug_debug_line = 6;pug_debug_filename = "mainPage.pug";
pug_mixins["folders"](locals.folderList);
pug_html = pug_html + "\u003C\u002Fdiv\u003E";
;pug_debug_line = 8;pug_debug_filename = "mainPage.pug";
pug_html = pug_html + "\u003Cdiv class=\"letterList\"\u003E";
;pug_debug_line = 9;pug_debug_filename = "mainPage.pug";
pug_mixins["LetterList"](locals.letterList);
pug_html = pug_html + "\u003C\u002Fdiv\u003E";
;pug_debug_line = 11;pug_debug_filename = "mainPage.pug";
pug_html = pug_html + "\u003Cdiv class=\"letter\"\u003E";
;pug_debug_line = 12;pug_debug_filename = "mainPage.pug";
pug_mixins["Letter"](locals.letter);
pug_html = pug_html + "\u003C\u002Fdiv\u003E";
;pug_debug_line = 14;pug_debug_filename = "mainPage.pug";
