...
function mainPage_template(locals) {
  ...
  try {
    ...
    (function (letter) {
      ...
      pug_debug_line = 53;
      pug_debug_filename = "./src/Views/PugTemplates/mainPage.pug";
      pug_html = pug_html + mainPage_pug_escape(null == (pug_interp = letter.Text) ? "" : pug_interp) + "</p></div></div></div></div>";
      ;
      pug_debug_line = 56;
      pug_debug_filename = "./src/Views/PugTemplates/mainPage.pug";
...
var MainPageView_MainPageView = /*#__PURE__*/function () {
  ...
  MainPageView_createClass(MainPageView, [{
    ...
    value: function render(data) {
      ...
      var buttonFolder = document.getElementsByClassName('form-add-folder-up')[1];
      ...
      var removeFolderForm = document.getElementById('remove-form-add-folder-up');
      ...
      folderRecivedChoose === null || folderRecivedChoose === void 0 ? void 0 : folderRecivedChoose.addEventListener('dblclick', function (event) {
        if (event.target.tagName === 'INPUT') {
