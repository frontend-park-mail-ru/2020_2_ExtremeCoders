      ...
      if (locals.screenWidth > 800) {
        ...
        if (locals.selectFolder) {
          ...
          if (local.offset !== 0 && local.offset <= 5) {
            ...
            pug_debug_line = 89;
            pug_debug_filename = "./src/Views/PugTemplates/mainPage.pug";
            pug_html = pug_html + "<div" + (" class=\"small-plus radius\"" + mainPage_pug_attr("title", local.nameOfFolder, true, false) + mainPage_pug_attr("id", local.offset, true, false) + " name=\"add-more\"" + mainPage_pug_attr("role", local.typeOfContent, true, false)) + "></div>";
          }
