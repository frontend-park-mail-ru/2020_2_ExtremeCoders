...
"use strict";
/* harmony import */ var _node_modules_css_loader_dist_runtime_cssWithMappingToString_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3);
...
var all_styles_v2 = __webpack_require__(1);
...
var update = injectStylesIntoStyleTag_default()(all_styles_v2["a" /* default */], options);
...
function pug_rethrow(n, e, r, t) {
  ...
  try {
    t = t || __webpack_require__(0).readFileSync(e, "utf8");
  } catch (e) {
...
function ProfilePage_template(locals) {
  ...
  try {
    ...
    pug_debug_line = 5;
    pug_debug_filename = "./src/Views/PugTemplates/ProfilePage.pug";
    pug_html = pug_html + "<div class=\"column large-12 intro\">";
    ;
    pug_debug_line = 6;
    pug_debug_filename = "./src/Views/PugTemplates/ProfilePage.pug";
    ...
    pug_debug_line = 6;
    pug_debug_filename = "./src/Views/PugTemplates/ProfilePage.pug";
    pug_html = pug_html + "\u041F\u0440\u043E\u0444\u0438\u043B\u044C</h1></div></div>";
    ;
    pug_debug_line = 8;
    pug_debug_filename = "./src/Views/PugTemplates/ProfilePage.pug";
    pug_html = pug_html + "<div class=\"row\">";
    ...
    pug_debug_line = 9;
    pug_debug_filename = "./src/Views/PugTemplates/ProfilePage.pug";
    pug_html = pug_html + "<div class=\"column large-4 tab-12\">";
    ;
    pug_debug_line = 10;
    pug_debug_filename = "./src/Views/PugTemplates/ProfilePage.pug";
    pug_html = pug_html + "<h3 class=\"h-add-bottom\">";
    ;
    pug_debug_line = 10;
    pug_debug_filename = "./src/Views/PugTemplates/ProfilePage.pug";
    ...
    pug_debug_line = 13;
    pug_debug_filename = "./src/Views/PugTemplates/ProfilePage.pug";
    pug_html = pug_html + "<input" + (" class=\"h-full-width\"" + " type=\"text\"" + ProfilePage_pug_attr("disabled", true, true, false)) + "/></div></div>";
    ;
    pug_debug_line = 15;
    pug_debug_filename = "./src/Views/PugTemplates/ProfilePage.pug";
    pug_html = pug_html + "<div class=\"column large-8 tab-12\">";
    ;
    pug_debug_line = 16;
    pug_debug_filename = "./src/Views/PugTemplates/ProfilePage.pug";
    ...
    pug_debug_line = 17;
    pug_debug_filename = "./src/Views/PugTemplates/ProfilePage.pug";
    pug_html = pug_html + ProfilePage_pug_escape(null == (pug_interp = locals.name) ? "" : pug_interp) + "</p>";
    ;
    pug_debug_line = 18;
    pug_debug_filename = "./src/Views/PugTemplates/ProfilePage.pug";
    pug_html = pug_html + "<h3>";
    ...
    pug_debug_line = 19;
    pug_debug_filename = "./src/Views/PugTemplates/ProfilePage.pug";
    pug_html = pug_html + ProfilePage_pug_escape(null == (pug_interp = locals.surname) ? "" : pug_interp) + "</p>";
    ;
    pug_debug_line = 20;
    pug_debug_filename = "./src/Views/PugTemplates/ProfilePage.pug";
    pug_html = pug_html + "<h3>";
    ...
    pug_debug_line = 21;
    pug_debug_filename = "./src/Views/PugTemplates/ProfilePage.pug";
    pug_html = pug_html + ProfilePage_pug_escape(null == (pug_interp = locals.email) ? "" : pug_interp) + "</p></div></div>";
    ;
    pug_debug_line = 23;
    pug_debug_filename = "./src/Views/PugTemplates/ProfilePage.pug";
    pug_html = pug_html + "<div class=\"row\">";
  ...
  try {
    ...
    (function (letter) {
        ...
        (function () {
          ...
          if ('number' == typeof $$obj.length) {
            for (var pug_index0 = 0, $$l = $$obj.length; pug_index0 < $$l; pug_index0++) {
              ...
              pug_debug_line = 17;
              pug_debug_filename = "./src/Views/PugTemplates/mainPage.pug";
              pug_html = pug_html + "<a" + (" class=\"block\"" + mainPage_pug_attr("id", folder.Name, true, false)) + ">";
              ;
              pug_debug_line = 17;
              pug_debug_filename = "./src/Views/PugTemplates/mainPage.pug";
              pug_html = pug_html + mainPage_pug_escape(null == (pug_interp = folder.Name) ? "" : pug_interp) + "</a>";
            }
          } else {
            var $$l = 0;
        ...
        (function () {
          ...
          if ('number' == typeof $$obj.length) {
            for (var pug_index2 = 0, $$l = $$obj.length; pug_index2 < $$l; pug_index2++) {
              ...
              pug_debug_line = 43;
              pug_debug_filename = "./src/Views/PugTemplates/mainPage.pug";
              pug_html = pug_html + "<h1" + (" class=\"entry__title\"" + mainPage_pug_attr("id", letter.Id, true, false)) + ">";
              ;
              pug_debug_line = 43;
              pug_debug_filename = "./src/Views/PugTemplates/mainPage.pug";
              ...
              pug_debug_line = 48;
              pug_debug_filename = "./src/Views/PugTemplates/mainPage.pug";
              pug_html = pug_html + "<p" + mainPage_pug_attr("id", letter.Id, true, false) + ">";
              ;
              pug_debug_line = 48;
              pug_debug_filename = "./src/Views/PugTemplates/mainPage.pug";
      ...
      if (letter.Id !== undefined) {
        ...
        pug_debug_line = 60;
        pug_debug_filename = "./src/Views/PugTemplates/mainPage.pug";
        pug_html = pug_html + "<input" + (" class=\"h-full-width\"" + " name=\"inFolderName\" type=\"text\" placeholder=\"Название папки\" autocomplete=\"off\"" + mainPage_pug_attr("required", true, true, false)) + "/></div>";
        ;
        pug_debug_line = 61;
        pug_debug_filename = "./src/Views/PugTemplates/mainPage.pug";
        pug_html = pug_html + "<div class=\"column large-6 tab-12 mob-12\">";
...
var MainPageView_MainPageView = /*#__PURE__*/function () {
  ...
  MainPageView_createClass(MainPageView, [{
    ...
    value: function render(data) {
      ...
      var addFolderRecived = document.getElementById('add-folder-recived');
      var buttonOfRecivedFolder = document.getElementsByName('button-of-recived-folder')[0];
      addFolderRecived.addEventListener('click', function (event) {
        event.preventDefault();
        addFolderRecived.classList.toggle('hide');
        buttonOfRecivedFolder.classList.toggle('hide');
      });
      var addFolderSend = document.getElementById('add-folder-send');
      var buttonOfSendFolder = document.getElementsByName('button-of-sended-folder')[0];
      addFolderSend.addEventListener('click', function (event) {
        event.preventDefault();
        addFolderSend.classList.toggle('hide');
        buttonOfSendFolder.classList.toggle('hide');
      });
      var summaryRecived = document.getElementById('summary-recived');
      summaryRecived.addEventListener('click', function (event) {
        event.preventDefault();
        src_EventBus.emit(Events.mainPageView.recivedFolder);
      });
      var summarySend = document.getElementById('summary-send');
      summarySend.addEventListener('click', function (event) {
        event.preventDefault();
      ...
      var recivedUn = document.getElementById('recivedUn');
      recivedUn.addEventListener('click', function (event) {
        event.preventDefault();
        src_EventBus.emit(Events.mainPageView.recivedUn);
      });
      var sendedUn = document.getElementById('sendedUn');
      sendedUn.addEventListener('click', function (event) {
        event.preventDefault();
        src_EventBus.emit(Events.mainPageView.sendedUn);
      });
      var addFolderButton = document.getElementsByName('button-of-recived-folder')[0];
      ...
      var addFolderButtonSended = document.getElementsByName('button-of-sended-folder')[0];
      addFolderButtonSended.addEventListener('submit', function (event) {
        event.preventDefault();
        src_EventBus.emit(Events.mainPageView.addFolderSended, new FormData(addFolderButtonSended));
      });
      var chooseFolder = document.getElementById('choose-folder');
      chooseFolder.addEventListener('submit', function (event) {
        event.preventDefault();
        var folderName = document.getElementsByName('inFolderName')[0];
        var currentName = document.getElementsByName('title-of-current')[0];
        var currentNameToogle = document.getElementById('toogle');
        var folder = folderName.value.trim();
        ...
        var type = '';
        if (currentNameToogle.checked) type = 'recived';else type = 'sended';
        var method = 'PUT';
        src_EventBus.emit(Events.mainPageView.inFolder, method, chooseFolderData, type);
      });
      var deleteFolder = document.getElementById('delete-folder');
...
var MainPageController_MainPageController = /*#__PURE__*/function () {
  function MainPageController(MainPageView) {
    ...
    src_EventBus.on(Events.mainPageView.selectFolder, function (folder) {
      console.log('SELECT LETTER ', folder, _this.data.letterList);
      src_EventBus.emit(Events.mainPageController.needGetLetterList, folder);

      var h = function h(data) {
        console.log('SELECTED LETTER');
        src_EventBus.off(Events.letterModelEvents.getLetterList.success, h);
        _this.data.letterList = data;
...
function SendLetterForm_template(locals) {
  ...
  try {
    ...
    pug_debug_line = 21;
    pug_debug_filename = "./src/Views/PugTemplates/SendLetterForm.pug";
    pug_html = pug_html + "\u041E\u0442\u043F\u0440\u0430\u0432\u0438\u0442\u044C</button></div></div></fieldset></form></div></section></div></div></section>";
  } catch (err) {
...
Models_UserModel.setUrl('http://localhost:8000');
var letterModel = new LetterModel_LetterModel('http://localhost:8000');
