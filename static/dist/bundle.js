...
function SignUpForm_template(locals) {
  ...
  try {
    ...
    pug_debug_line = 26;
    pug_debug_filename = "./src/Views/PugTemplates/SignUpForm.pug";
    pug_html = pug_html + "<input" + (" class=\"h-full-width\"" + " name=\"avatar\" id=\"file\" type=\"file\" placeholder=\"\u0417\u0430\u0433\u0440\u0443\u0437\u0438\u0442\u044C \u0430\u0432\u0430\u0442\u0430\u0440\" accept=\"image/jpeg, image/png, image/jpg\" value=\"\" autocomplete=\"off\"" + SignUpForm_pug_attr("required", true, true, false)) + "/></div>";
    ;
    pug_debug_line = 28;
    pug_debug_filename = "./src/Views/PugTemplates/SignUpForm.pug";
    pug_html = pug_html + "<div class=\"row\">";
